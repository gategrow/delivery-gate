...
Originally submitted as [affaan-m/ECC PR #2365](https://github.com/affaan-m/ECC/pull/2365). This standalone repo is the same code, extracted for direct use without requiring the full ECC installation.
